...
from .user import PostgreSQLUserRepository
...
class PostgreSQLUserUnitOfWork:
    def __init__(self, session: AsyncSession):
        ...
        self.repository: PostgreSQLUserRepository | None = None # объявляем репозиторий

    async def __aenter__(self):
        self.repository = PostgreSQLUserRepository(self._session) # инициализируем репозиторий
        return self
